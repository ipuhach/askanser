...
using Askanser.Web.Email;
using Microsoft.AspNet.Identity;
using Microsoft.Owin.Security;
using ExternalLoginConfirmationViewModel = Askanser.Web.ViewModels.ExternalLoginConfirmationViewModel;
using ForgotPasswordViewModel = Askanser.Web.ViewModels.ForgotPasswordViewModel;
using LoginViewModel = Askanser.Web.ViewModels.LoginViewModel;
using RegisterViewModel = Askanser.Web.ViewModels.RegisterViewModel;
using ResetPasswordViewModel = Askanser.Web.ViewModels.ResetPasswordViewModel;
